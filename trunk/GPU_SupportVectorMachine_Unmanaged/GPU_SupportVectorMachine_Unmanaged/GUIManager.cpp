...
namespace SVM_Framework{
	GUIManager::GUIManager(HWND hwnd, HINSTANCE hInst){
		...
		addWindow(IDC_EDIT_PARAM2,L"EDIT",WS_EX_CLIENTEDGE,WS_VISIBLE|WS_CHILD,1105,110,50,21,L"0.125");
		addWindow(IDC_EDIT_PARAM3,L"EDIT",WS_EX_CLIENTEDGE,WS_VISIBLE|WS_CHILD,1160,110,50,21,L"1.0");
		addWindow(IDC_EDIT_FILEPATH,L"EDIT",WS_EX_CLIENTEDGE,WS_VISIBLE|WS_CHILD,455,7,580,21,L"E:/Projekts/DSV/Current/Exjobb/Program/Training files/DataSets/1460.csv_clean.smi.oeselma.tr.rds_txt");
